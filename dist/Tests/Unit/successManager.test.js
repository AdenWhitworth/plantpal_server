...
describe('successHandler', () => {
    ...
    it('should return a 200 response with a success message when no statusCode is provided', () => {
        (0, successManager_1.successHandler)('Success message', 0, mockResponse);
    ...
    it('should return the provided statusCode and message', () => {
        (0, successManager_1.successHandler)('Custom success', 201, mockResponse);
    ...
    it('should include optional accessToken in the response', () => {
        (0, successManager_1.successHandler)('Token success', 200, mockResponse, 'mock_access_token');
        expect(statusMock).toHaveBeenCalledWith(200);
        expect(jsonMock).toHaveBeenCalledWith({
    ...
    it('should include devices, deviceLogs, lastLog, device, user, and deviceShadow if provided', () => {
        ...
        (0, successManager_1.successHandler)('Complete success', 200, mockResponse, 'mock_access_token', [mockDevice], [mockDeviceLog], mockDeviceLog, mockDevice, mockUser, mockDeviceShadow);
        expect(statusMock).toHaveBeenCalledWith(200);
        expect(jsonMock).toHaveBeenCalledWith({
